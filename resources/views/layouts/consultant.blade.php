            ...
            <div class="px-4 py-3 lg:px-6 lg:pl-3">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <!-- Logo -->
                        <a href="{{ route('consultant.dashboard') }}" class="flex items-center ml-2 lg:ml-0 space-x-3">
                    ...
                    <div class="flex items-center space-x-4">
                        <!-- Quick Stats -->
                        <div class="hidden md:flex items-center space-x-4 px-4 border-l border-gray-200 dark:border-gray-700">
                            <div class="text-center">
                                <p class="text-xs text-gray-500 dark:text-gray-400">Active</p>
                                <p class="text-lg font-bold text-purple-600 dark:text-purple-400">{{ auth()->user()->assignedApplications()->active()->count() }}</p>
                            </div>
                            <div class="text-center">
                                <p class="text-xs text-gray-500 dark:text-gray-400">Today</p>
                                <p class="text-lg font-bold text-blue-600 dark:text-blue-400">{{ auth()->user()->consultantAppointments()->whereDate('scheduled_at', today())->count() }}</p>
                            </div>
                        </div>
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open" class="relative p-2 text-gray-500 rounded-lg hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700">
                                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div x-show="open" @click.away="open = false" x-transition class="absolute right-0 mt-2 w-96 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden z-50">
                                <div class="px-4 py-3 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-purple-50 to-purple-100 dark:from-gray-800 dark:to-gray-700">
                                    <div class="flex items-center justify-between">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <div x-show="open" @click.away="open = false" x-transition class="absolute right-0 z-50 mt-2 w-56 bg-white dark:bg-gray-700 divide-y divide-gray-100 dark:divide-gray-600 rounded-lg shadow-lg">
                                ...
                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200">
                                    <li><a href="{{ route('consultant.profile') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600">Profile Settings</a></li>
        ...
        <aside id="consultant-sidebar" 
            ...
            <div class="h-full px-3 pb-4 overflow-y-auto">
                <ul class="space-y-2 font-medium">
                    ...
                    <!-- Reports -->
                    <li>
                        <a href="{{ route('consultant.reports.index') }}" 
                           class="flex items-center p-2 rounded-lg text-white hover:bg-white/10 {{ request()->routeIs('consultant.reports.*') ? 'bg-white/20' : '' }}">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
