...
@section('title', 'Application Documents - ' . $application->application_number)
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            <div class="flex items-center gap-2 mb-2">
                <a href="{{ route('admin.applications.show', $application) }}" class="text-purple-600 hover:text-purple-700">
                    {{ $application->application_number }}
                </a>
                <span class="text-gray-500">/</span>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Documents</h1>
            </div>
            <p class="text-gray-600 dark:text-gray-400">{{ $application->user->name }}</p>
        </div>
        <a href="{{ route('admin.applications.show', $application) }}" class="px-4 py-2 bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-lg font-medium transition-colors">
            ← Back to Application
        </a>
    </div>
        ...
        <form method="GET" class="space-y-4">
            ...
            <div class="flex flex-wrap items-end gap-4">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('admin.documents.application', $application) }}" class="px-6 py-2 bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-lg font-medium transition-colors">
                        Clear
                    </a>
                </div>
            </div>
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-900/50">
                            ...
                            <td class="px-6 py-4">
                                <p class="text-sm text-gray-900 dark:text-white">
                                    {{ $document->documentRequirement->name ?? 'N/A' }}
                                </p>
                            </td>
                            <td class="px-6 py-4">
