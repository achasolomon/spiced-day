...
<div id="toast-container" class="fixed top-4 right-4 z-[9999] space-y-2 max-w-md w-full pointer-events-none"></div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!document.getElementById('toast-container')) {
        ...
        container.className = 'fixed top-4 right-4 z-[9999] space-y-2 max-w-md w-full pointer-events-none';
