            ...
            <div class="flex items-start gap-2">
                ...
                <div>
                    <p class="text-sm font-medium text-amber-900 dark:text-amber-200">
                        {{ $pendingDocuments->count() }} required document(s) missing
                    </p>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
                ...
                @else
                    <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3 text-sm text-blue-800 dark:text-blue-200">
                        Document uploads are not yet enabled. Please wait for your consultant to enable document submission.
                    </div>
                @endif
            </div>
        </div>
      ...
      <div class="lg:col-span-2">
        <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
            ...
            <div class="divide-y divide-gray-200 dark:divide-gray-700">
                @forelse($uploadedDocuments as $requirementId => $documents)
                    @php
                        $requirement = $requiredDocuments->firstWhere('id', $requirementId) 
                                    ?? $documents->first()->documentRequirement;
                    @endphp
                    
                    <div class="p-4">
                        <h3 class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">
                            {{ $requirement->name ?? 'Other Documents' }}
                        </h3>
                        <div class="space-y-2">
        ...
        <div x-show="showModal" 
            ...
            <div class="fixed inset-0 flex items-center justify-center p-4">
                <div class="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full h-[95vh] flex flex-col" style="max-width: 900px;" @click.stop>
