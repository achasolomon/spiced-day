    ...
    <div class="p-4 sm:p-6">
        ...
        @php
            $stages = [
                ...
                ['name' => 'Interviews', 'status' => ['phone_interview_scheduled', 'phone_interview_completed', 'meet_and_greet_scheduled', 'meet_and_greet_completed']],
                ['name' => 'Initial Inspection', 'status' => ['initial_inspection_scheduled', 'initial_inspection_completed']],
                ['name' => 'Documents', 'status' => ['documents_pending', 'documents_submitted']],
            ...
            $statusToStageMap = [
                'draft' => 0,
                'submitted' => 1,
                'phone_interview_scheduled' => 2,
                'phone_interview_completed' => 2,
                'meet_and_greet_scheduled' => 2,
                'meet_and_greet_completed' => 2,
                'initial_inspection_scheduled' => 3,
                'initial_inspection_completed' => 3,
                'documents_pending' => 4,
                'documents_submitted' => 4,
                'second_inspection_scheduled' => 5,
                'second_inspection_completed' => 5,
                'contract_signing_scheduled' => 6,
                'contract_signed' => 6,
                'approved' => 7,
            ];
            
            $currentStageIndex = $statusToStageMap[$activeApplication->status] ?? 0;
