    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <p class="text-gray-900 dark:text-white">{{ $appointment->scheduled_at->format('l, F j, Y') }}</p>
                <p class="text-gray-900 dark:text-white font-semibold">{{ $appointment->scheduled_at->format('g:i A') }}</p>
            </div>
